...
// Core App
Core core(Application::AppId::CoreApp, "Core");

// WifiMan App
WifiMan wifiMan(Application::AppId::WifiManApp, "WiFi");

// Custom App
CUSTOM_APP_CLASS custom(Application::AppId::CustomApp, CUSTOM_APP_NAME);
